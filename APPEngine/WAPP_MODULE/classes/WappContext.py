...
# Direct import of LoggerManager class from the same folder
from .LoggerManager import LoggerManager


class WappContext:
    """Stores global configuration, logger, and execution paths."""
    ...
    def __init__(self, path_to_archive, output_directory, case_name, machine_name, separator, main_id, artefact_config,
        ...
        # Tools
        self.tool_path = os.environ.get("TOOL_PATH", "/python-docker/WAPP_MODULE/utils")
        ...
        self.siem_ingestion_dir = self.parsed_dir / "siemIngestion"
    ...
    def _init_directories(self):
        dirs_to_create = [
            ...
            self.timeline_dir, self.siem_ingestion_dir
        ]
