...
if __name__ == "__main__":
    ...
    # curl -X POST https://WFAPP.localhost/api/parse/parse_archive -F upload=/home/hro/Documents/working_zone/archive_orc/DFIR-ORC_WorkStation_DESKTOP-9I162HO1.7z -F data='{"caseName":"test"}'