...
WFAPP_API = "https://WFAPP.localhost"
...
def parse_archive():
    ...
    try:
        ...
        status_uri = url_for('wfapp_api.check_task', task_id=task.id)
        run_uri = url_for('wfapp_api.check_logs_run', task_id=task.id)
        response = {
            "message": "your parsing request has been send to queue",
            "taskId": "{}".format(task.id),
            "statusUrl": "{}{}".format(WFAPP_API, status_uri),
            "runLogUrl": "{}{}".format(WFAPP_API, run_uri)
        }
        time.sleep(1)
