...
* **Documentation:** [Installation Guide](installation.md) | [GUI Guide](GUI_GUIDE.md) | [Results Architecture](Explaining_the_results.md) | [Configure SIEM Ingestion](Configure_SIEM.md)
